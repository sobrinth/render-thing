use super::{DynamicRendering, Options, RendererResult};
use ash::{Device, vk};
...
mod buffer {
    ...
    use super::super::allocator::{Allocator, Memory};
    use ash::Device;
    use ash::vk;

    pub(crate) fn create_and_fill_buffer<T>(
        device: &Device,
        ...
        T: Copy,
    {
        ...
        let (buffer, mut memory) = allocator.create_buffer(size, usage)?;
